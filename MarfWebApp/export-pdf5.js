document.addEventListener('DOMContentLoaded', function () {
  document.getElementById('exportPdf').addEventListener('click', function () {
    ...
    .then(data => {
      ...
      const { street, nr, bloc, localitate, judet , cif} = data;
      ...
      doc.setFont('helvetica', 'normal', pageWidth / 2, 30, { align: 'center' });
      doc.text(`C.I.F.: ${cif}`)
      doc.setFontSize(24);
      doc.setFont('helvetica', 'bold');
      ...
      doc.text(`Subsemnatul ${subsemnatul}, in calitate de Administrator , propun Comitetului Executiv aprobarea achizitionarii urmatoarelor produse/servicii:`, 10, 100);
